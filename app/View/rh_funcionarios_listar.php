<div id="refresca_rh_func">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="rh_funcionarios_incluir.php" class="btn btn-primary btn-dropbox" data-toggle="modal" data-target="#myModal">Inserir Novo Funcionário</a><br>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                            ...
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pdo->query($sql) as $value) {
                                        ...
                                        echo '<td><small><a href="rh_funcionarios_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-small btn-dropbox">Editar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></small></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
