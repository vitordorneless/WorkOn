    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/lista_nominal_gerar_link.php",
...
<div class="widget">
    <div class="widget-header transparent">
        <h2><strong>Lista Nominal</strong> <acronym title="Informe os campos para otimizar o resultado!!!">Walmart</acronym></h2>
