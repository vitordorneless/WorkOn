    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/tst_nome_cargos_incluir.php",
...
<div class="modal-header">
    <h2><strong>Incluir</strong> Cargos TST</h2>
...
<div class="modal-body">
    <div id="basic-form">
        <form id="form" method="POST">
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-linkedin pull-right" id="envia" type="submit">Salvar Cargo TST <span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span></button>
            </div>
        </form>
    </div>
</div>
