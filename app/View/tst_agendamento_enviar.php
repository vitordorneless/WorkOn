        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2><strong>Listar </strong>Agendamentos TST para enviar via Email</h2>
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select id, id_unidade, id_turnos, id_situacao, data_agendamento, status, check_list from tst_agendamento where status in (1) and id_situacao not in (2) order by data_agendamento asc";
                                    foreach ($pdo->query($sql) as $value) {
                                        ...
                                        echo '<td><a href="tst_agendamento_enviar_email.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Enviar Email <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
