...
<script>
    $(document).ready(function () {
        ...
        function envia_array() {
            ...
            alert("passou");
            alert("My favourite matricula are: " + favorite.join(", "));

            $.ajax({
                type: "GET",
                dataType: "HTML",
                url: "../Controller/periodico_realizados.php",
                data: "periodico=" + favorite,
                beforeSend: function () {
                    $("#periodico").html("<img src='../../images/loading/load.gif' class='img-rounded img-responsive' id='imgpos'>");
                },
                success: function (response) {
    ...
    <div class="widget-content padding">
        <div class="form-inline">
            <form id="form" method="POST">
                ...
                <button class="btn btn-primary" id="envia" type="submit">Gerar Online</button>
            </form>
        </div>
    </div>
