...
<div id="refresca_cassi_solicitante">
    <script src="../js/JQuery/jquery-1.11.1.min.js"></script><!--sempre chamar, com jquery ui o $ajax nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o funciona-->
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = $_SESSION['setor'] === 12 ? $querie->listar_demanda_user($_SESSION['setor']) : $querie->listar_demanda_userr($_SESSION['user_id']);
                                    foreach ($pdo->query($sql) as $value) {
                                        ...
                                        if ($value['id_status'] === '2') {
                                            if ($value['destino_setor'] === "2") {
                                                echo '<td><a href="minhas_demandas_qualidade_registro.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Encerrar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                            } else {
                                                echo '<td><a href="minhas_demandas_qualidade.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Encerrar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                            }
                                        } else {
                                            echo '<td>Aguardando Qualidade!</td>';
                                        }
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
