    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/tst_nome_agenda_editar.php",
    ...
    <div id="basic-form">
        <form id="form" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nome_agendamento" name="nome_agendamento" value="<?php echo $array_tst['nome_agendamento']; ?>">
