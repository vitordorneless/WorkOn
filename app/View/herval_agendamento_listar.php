<div id="refresca_herval">
    ...
    <div class="row">
        <div class="col-md-3">
            <a href="herval_agendamento_incluir.php" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Incluir Agendamento <span class="glyphicon glyphicon-save" aria-hidden="true"></span></a><br><br><br>
        </div>        
    </div>
    <div class="row">
        <div class="col-md-12">
                            ...
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pdo->query($sql) as $value) {
                                        ...
                                        echo '<td><a href="herval_agendamento_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-danger">Editar Agendamento <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
