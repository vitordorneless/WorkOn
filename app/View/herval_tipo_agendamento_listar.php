<div id="refresca_herval_tipo_agendamento">
    ...
    <div class="row">
        <div class="col-md-3">
            <a href="herval_tipo_agendamento_incluir.php" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Incluir Agendamento <span class="glyphicon glyphicon-save" aria-hidden="true"></span></a><br><br><br>
        </div>        
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2><strong>Listar </strong>Tipos de Agendamentos Herval</h2>                    
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select id, nome_agendamento, status from herval_tipos_agendamentos where status = 1 order by nome_agendamento asc";
                                    foreach ($pdo->query($sql) as $value) {
                                        echo '<tr>';                                        
                                        echo '<td>' . $value['nome_agendamento'] . '</td>';
                                        $situation = $value['status'] == 1 ? "Ativo" : "Inativo";
                                        echo '<td>' . $situation . '</td>';                                        
                                        echo '<td><a href="herval_tipo_agendamento_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Editar Tipo de Agendamento <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';                                        
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
