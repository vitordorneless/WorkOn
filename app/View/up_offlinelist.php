        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2><strong>Listar </strong>Arquivos Offline que foram inseridos via Ferramenta Periódicos</h2>
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pdo->query($querie->listar_arquivo_offline_upados()) as $value) {
                                        echo '<tr>';
                                        echo '<td>' . $value['nome_arquivo'] . '.xls</td>';
                                        echo '<td>' . $value['nome_medico'] . '</td>';
