...
<div class="container well">
    <div class="titlepage text-center"><h2>Dados E-social</h2></div>
    <br/><br/><br/>
    <section id="plans">
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center">
                    <div class="panel panel-danger panel-pricing">
                        ...
                        <div class="panel-body text-center">
                            <p><strong>Para salvar em sua máquina ou enviar para o Walmart</strong></p>
                        </div>
                        ...
                        <div class="panel-footer">
                            <a class="btn btn-lg btn-block btn-danger" href="../Controller/wal_doctors_report.php">Gerar em Excel!</a>
                        </div>
                    </div>
                </div>                
            </div>
