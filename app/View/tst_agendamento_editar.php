    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/tst_agendamento_editar.php",
                data: "id_agendamento=" + id_agendamento + "&id_unidade=" + id_unidade + "&id_turnos=" + id_turnos + "&id_situacao=" + id_situacao +
                        "&data_agendamento=" + data_agendamento + "&id_tecnicos=" + id_tecnicos + "&obs=" + obs + "&id=" + id + "&status=" + status,
                beforeSend: function () {
    ...
    <div id="basic-form">
        <form id="form" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="obs" name="obs" placeholder="Informe aqui, dados adicionais!!"><?php echo $array_agendamento['obs']; ?></textarea>
