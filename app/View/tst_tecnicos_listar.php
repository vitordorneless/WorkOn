<div id="refresca_tst_tipo_agendamento">
    ...
    <div class="row">
        <div class="col-md-3">
            <a href="tst_tecnicos_incluir.php" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Incluir Técnico em Segurança do Trabalho <span class="glyphicon glyphicon-save" aria-hidden="true"></span></a><br><br><br>
        </div>        
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select id, nome, registro, cpf, status from tst_tecnicos where status in (1) order by nome asc";
                                    foreach ($pdo->query($sql) as $value) {
                                        ...
                                        echo '<td><a href="tst_tecnicos_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Editar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
