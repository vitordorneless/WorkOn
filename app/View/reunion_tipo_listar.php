<div id="refresca_rh">
    ...
    <div class="container">
        <div class="col-md-6">
            <a href="reunion_tipo_incluir.php" class="btn btn-primary btn-facebook" data-toggle="modal" data-target="#myModal">Inserir Novo Tipo de Reunião</a><br>
        </div>
    </div>
    <div class="row">        
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2 class="text-center"><strong>Listar </strong>Tipos de Reuniões</h2>
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select id, tipo, status from reuniao_tipos where status in (1) order by tipo asc";
                                    foreach ($pdo->query($sql) as $value) {
                                        echo '<tr>';                                        
                                        echo '<td>' . utf8_encode($value['tipo']) . '</td>';
                                        $situation = $value['status'] == 1 ? "Ativo" : "Inativo";
                                        echo '<td>' . $situation . '</td>';
                                        echo '<td><a href="reunion_tipo_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal1" class="btn btn-default">Editar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
