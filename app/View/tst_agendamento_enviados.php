        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2><strong>Listar </strong>Agendamentos Enviados TST</h2>                    
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select id, id_unidade, id_turnos, id_situacao, data_agendamento, status, check_list from tst_agendamento where status in (1) and id_situacao in (2) order by data_agendamento asc";
