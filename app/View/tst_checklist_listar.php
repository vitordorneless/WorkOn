        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2><strong>Listar </strong>Agendamentos TST para Incluir Checklist</h2>                    
                            ...
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pdo->query($sql) as $value) {
                                        ...
                                        echo '<td><a href="tst_checklist_incluir.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-danger">Incluir Checklist <span class="glyphicon glyphicon-save" aria-hidden="true"></span></a></td>';
                                        }else{
                                            echo '<td><a href="tst_checklist_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-info">Editar Checklist <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        }
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
