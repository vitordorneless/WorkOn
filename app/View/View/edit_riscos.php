...
$apto_altura = new Wal_Apto_Altura();
...
$apto_alturas = $apto_altura->Sou_Apto_Altura($riscos->get_id());
...
$id_apto = $apto_altura->id_Apto_Altura($riscos->get_id());
?>
    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/edit_riscos.php",
                data: "id_funcionario=" + id_funcionario + "&trab_altura=" + trab_altura + "&apto_trab_altura=" + apto_trab_altura + "&id_apto=" + id_apto + "&acuidade_visual=" + acuidade_visual,
                beforeSend: function () {
    ...
    <div class="panel-body">
        <form id="form" method="POST">
            <div class="form-group">
                <input type="hidden" class="form-control" id="id_funcionario" name="id_funcionario" value="<?php echo $riscos->get_id(); ?>">
                <input type="hidden" class="form-control" id="id_apto" name="id_apto" value="<?php echo $id_apto['id']; ?>">
                <table>
                    <tr>
                        <td>
                            <div class="checkbox">
                    ...
                    <tr>
                        <td>
                            <div class="checkbox">
                                <label>
                                    <input name="trab_altura" id="trab_altura" type="checkbox" <?php $trab_altura = $array_marca_exames['trab_altura'] == 1 ? 'checked' : '';
                                    echo $trab_altura; ?>><strong> Trabalho em Altura</strong> 
                                </label>                        
                            </div>
                        </td>
                        <td style="width: 60%;">                            
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <div class="checkbox">
                                <label>
                                    <input name="apto_trab_altura" id="apto_trab_altura" type="checkbox" <?php $apto_trab_altura = $apto_alturas['temos'] > 0 ? 'checked' : '';
                                    echo $apto_trab_altura; ?>><strong> APTO TRABALHAR EM ALTURA</strong> 
                                </label>                                
                            </div>
                        </td>
                        <td></td>
