<div id="refresca_cassi_solicitante">
    ...
    <div class="row">
        <div class="col-md-8">
            <a href="cassi_solicitante_incluir.php" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-dropbox">Incluir Solicitante <span class="glyphicon glyphicon-save" aria-hidden="true"></span></a><br><br><br>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $querie = new Queries();
                                    foreach ($pdo->query($querie->cassi_solicitante_listar()) as $value) {

                                        echo '<tr>';
                                        echo '<td>' . utf8_encode($value['nome']) . '</td>';
                                        $situation = $value['status'] == 1 ? "Ativo" : "Inativo";
                                        echo '<td>' . $situation . '</td>';
                                        echo '<td><a href="cassi_solicitante_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Alterar Solicitante <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
