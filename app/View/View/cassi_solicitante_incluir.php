    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/cassi_solicitante_incluir.php",
                data: "nome=" + nome,
                beforeSend: function () {
...
<div class="modal-body">
    <form id="form" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nome" name="nome" placeholder="Informe o Nome do Solicitante..." autofocus>            
            <div class="form-inline" id="nome_error"></div>
        </div>
        <button class="btn btn-primary btn-dropbox pull-right" id="envia" type="submit">Adicionar Solicitante CASSI <span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span></button>
    </form>
</div>
