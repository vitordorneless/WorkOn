...
<div class="row">
    <div class="widget">
        <div class="widget-header transparent">    
            <h4 class="modal-title">Meu Diário!!</h4>
        </div>
        <div class="widget-content padding">
            <form id="form" method="POST">
                <div class="form-group">
                    <label for="label_consulta">Diário:</label>                    
                    <textarea class="form-control" id="malacabado" name="malacabado" cols="250" rows="25"></textarea>
                    <div class="form-inline" id="malacabado_error"></div>
                </div>
                <button class="btn btn-primary btn-dropbox pull-right" id="envia" type="submit">Publicar <span class="glyphicon glyphicon-baby-formula" aria-hidden="true"></span></button>
            </form>
        </div>
    </div>
    <div class="widget">
