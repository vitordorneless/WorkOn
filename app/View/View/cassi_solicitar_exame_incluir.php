    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/cassi_solicitar_exame_incluir.php",
                data: "id_exame=" + id_exame + "&data_solicitacao=" + data_solicitacao + "&nome_combo=" + nome_combo + "&nome=" + nome + "&rg=" + rg + 
                        ...
                        "&horario=" + horario + "&data_exame=" + data_exame + "&obs=" + obs + "&status=" + status + "&user=" + user,
                beforeSend: function () {
...
<div class="modal-header">
    ...
    <h4 class="modal-title">Incluir Solicitante CASSI</h4>
</div>			
<div class="modal-body">
    <form id="form" method="POST">
        <div class="form-group">
            ...
            <select class="form-control" id="id_exame" name="id_exame">
                ...
                foreach ($pdo->query($sql) as $value) {
                    echo '<option value="' . $value['id'] . '">' . utf8_encode($value['nome_exame']) . '</option>';
                }
                ?>
            </select>
        ...
        <div class="form-group">
            <label for="label_nome_combo">Nome via listagem:</label>
            <select class="form-control" id="nome_combo" name="nome_combo">
                <option selected value="na">
                    Selecione...
                </option>
                <?php
                $sql1 = "select nome_ativo from cassi_ativos where status = 1 order by nome_ativo asc";
                foreach ($pdo->query($sql1) as $value) {
                    echo '<option value="' . $value['nome_ativo'] . '">' . utf8_encode($value['nome_ativo']) . '</option>';
                }
                ?>
            </select>            
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nome" name="nome" placeholder="Informe o Nome do Ativo CASSI...">            
            <div class="form-inline" id="nome_error"></div>
        </div>
        <div class="form-group">
            <label for="label_rg">Identidade:</label>            
            <input type="text" class="form-control" id="rg" name="rg" placeholder="Informe a Identidade..." maxlength="20">
            <div class="form-inline" id="rg_error"></div>
        </div>
        <div class="form-group">
            <label for="label_cpf">CPF:</label>
            <input type="text" class="form-control" id="cpf" name="cpf" placeholder="Informe o CPF..." maxlength="11">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="funcao" name="funcao" placeholder="Informe a Função...">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="id_cidade_solicitada" name="id_cidade_solicitada" required>
                ...
                foreach ($pdo->query($sql4) as $value) {
                    echo '<option value="' . $value['id'] . '">' . utf8_encode($value['nom_cidade']) . '</option>';
                }
                ?>
            </select>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="turno" name="turno">
                ...
                foreach ($pdo->query($sql6) as $value) {
                    echo '<option value="' . $value['id'] . '">' . utf8_encode($value['nome_turno']) . '</option>';
                }
                ?>
            </select>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="status" name="status">
                ...
                foreach ($pdo->query($sql7) as $value) {
                    echo '<option value="' . $value['id'] . '">' . utf8_encode($value['nome_status']) . '</option>';
                }
                Database::disconnect();
                ?>
            </select>
