                                ...
                                <tbody>
                                    ...
                                    function __autoload($file) {
                                        if (file_exists('../Model/' . $file . '.php'))
                                            ...
                                            exit('O arquivo ' . $file . ' nÃƒÂ£o foi encontrado!');
                                    }

                                    $querie = new Queries();
                                    $date_default = new DateTime();
                                    $hoje = $date_default->format('Y-m-d');
                                    foreach ($pdo->query($querie->listar_demanda_com_setor($_SESSION['setor'])) as $value) {
                                        ...
                                        switch ($data_prazo['tipo']) {
                                            case 'horas':
                                                ...
                                                if ($dt_ult_alt->format('H') >= 17) {
                                                    $dt_ult_alt->add(new DateInterval("PT19H"));
                                                }                                                
                                        ...
                                        echo '<td><a href="demanda_edit.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Editar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
