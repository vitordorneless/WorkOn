                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pdo->query($querie->listar_kit_convocacao()) as $value) {
                                        echo '<tr>';
                                        ...
                                        echo '<td>' . $kit . '</td>';                                        
                                        if($value['kit'] != 1){
                                        echo '<td><a href="convocar_kits.php?id=' . $value['id_evento'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-success">Despachar Kit <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></td>';
                                        }else{
                                            echo '<td><a href="convocar_kits_editar.php?id=' . $value['id_evento'] . '" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-success">Editar Kit <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></td>';
                                        }
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
