...
<div class="container well">
    <div class="titlepage text-center"><h2>Relatório Clínicas</h2></div>
    <br/><br/><br/>
    <section id="plans">
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center">
                    <div class="panel panel-danger panel-pricing">
                        ...
                        <div class="panel-footer">
                            <a class="btn btn-lg btn-block btn-danger" href="../Controller/clinicas_excel.php">Gerar em Excel!</a>
                        </div>
                    </div>
                </div>                
                <div class="col-md-4 text-center">
