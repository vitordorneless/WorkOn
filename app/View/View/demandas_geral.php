                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pdo->query($querie->listar_demanda()) as $value) {
                                        ...
                                        if ($value['destino_setor'] === "2") {
                                            echo '<td><a href="demandas_geral_qualidade_registro.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Ver <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        } else {
                                            echo '<td><a href="demandas_geral_qualidade.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Ver <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        }
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
