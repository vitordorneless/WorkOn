<div id="refresca_cassi_solicitante">
    ...
    <div class="row">
        <div class="col-md-8">
            <a href="demandas_admin_status_incluir.php" data-toggle="modal" data-target="#myModal1" class="btn btn-default btn-dropbox">Incluir Status <span class="glyphicon glyphicon-save" aria-hidden="true"></span></a><br><br>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2><strong>Listar </strong>Status para os Tipos de Demandas</h2>                    
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $querie = new Queries();
                                    foreach ($pdo->query($querie->demanda_admin_listar_status()) as $value) {
                                        echo '<tr>';
                                        echo '<td>' . utf8_encode($value['status']) . '</td>';                                        
                                        echo '<td><a href="demandas_admin_status_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-dropbox">Editar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
