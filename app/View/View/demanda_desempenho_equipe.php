...
$array_demandas = $demandas->Total_demandas_funcionario($_SESSION['setor']);
$demandas_open = $demandas->Total_demandas_open($_SESSION['setor']);
$demandas_qualidade = $demandas->Total_demandas_Qualidade();
$array_media = $demandas->media_tempo($_SESSION['setor']);
$array_setor = $setor->Dados_Usuarios_Setores($_SESSION['setor']);
foreach ($pdo->query($querie->grafico_barra_setor($_SESSION['setor'])) as $value) {
...
foreach ($pdo->query($querie->grafico_barra_setor_que_mais_pede($_SESSION['setor'])) as $value) {
...
$megastring = "";
foreach ($pdo->query($querie->top_five_demandas($_SESSION['setor'])) as $value) {
    switch ($counts) {
        case 0:
    ...
    <div class="col-md-12 portlets">
        <div class="widget">
            <div class="widget-header">
                <h2><strong>Desempenho Equipe</strong> <?php echo $array_setor['setor']; ?></h2>
            </div>
