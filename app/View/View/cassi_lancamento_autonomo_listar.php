    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/cassi_lancamento_autonomo_listar.php",
                data: "search=" + search,
                beforeSend: function () {
...
<div class="widget">
    <div class="widget-header transparent">
        <h2><strong>Listar Associados</strong><acronym title="Informe os campos para otimizar o resultado!!!"> CASSI</acronym></h2>
    ...
    <div class="widget-content padding">
        <div class="form-group">
            <form id="form" method="POST">
                <div class="form-group">
                    <label for="empresa_label">Nome do Associado CASSI:</label>
