<div id="refresca_rh">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="rh_instrucao_escolar_incluir.php" class="btn btn-primary btn-facebook" data-toggle="modal" data-target="#myModal">Inserir Novo Grau de Instrução Escolar</a><br>
        </div>
    </div>
    <div class="row">        
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <h2 class="text-center"><strong>Listar </strong>Grau de Instrução Escolar</h2>
                        ...
                        <form class='form-horizontal' role='form'>
                            <table id="funcionarios" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select id, grau, status from rh_grau_instrucao_escolar where status in (1) order by grau asc";
                                    foreach ($pdo->query($sql) as $value) {
                                        echo '<tr>';                                        
                                        echo '<td>' . $value['grau'] . '</td>';                                        
                                        $situation = $value['status'] == 1 ? "Ativo" : "Inativo";
                                        echo '<td>' . $situation . '</td>';
                                        echo '<td><a href="rh_instrucao_escolar_editar.php?id=' . $value['id'] . '" data-toggle="modal" data-target="#myModal" class="btn btn-default">Editar <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                        echo '</tr>';
                                    }
                                    Database::disconnect();
                                    ?>
