...
$array = $tst->Dados_TST_Checklists($tst->get_id());
?>
    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/tst_checklist_editar.php",
                data: "id_agendamento=" + id_agendamento + "&horario_trabalho=" + horario_trabalho + "&inicio_vistoria=" + inicio_vistoria + 
                        ...
                        "&sugestao_melhoria=" + sugestao_melhoria + "&id=" + id + "&status=" + status,
                beforeSend: function () {
...
<div class="modal-header">
    <h2><strong>Editar</strong> Checklist TST</h2>
    ...
    <div id="basic-form">
        <form id="form" method="POST">            
            <div class="form-group">
                ...
                <input type="time" class="form-control" id="horario_trabalho" name="horario_trabalho" value="<?php echo $array['horario_trabalho']; ?>">
                <input type="hidden" id="id_agendamento" name="id_agendamento" value="<?php echo $array['id_agendamento']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="time" class="form-control" id="inicio_vistoria" name="inicio_vistoria" value="<?php echo $array['inicio_vistoria']; ?>">
                <div class="form-inline" id="inicio_vistoria_error"></div>
            </div>
            <div class="form-group">
                <label for="label_data_agendamento">Término Vistoria:</label>
                <input type="time" class="form-control" id="termino_vistoria" name="termino_vistoria" value="<?php echo $array['termino_vistoria']; ?>">
                <div class="form-inline" id="termino_vistoria_error"></div>
            </div>
            <?php
            $format_data = trim($array['data_vistoria']);
            $date_format = date("Y-m-d", strtotime($format_data));
            ?>
            <div class="form-group">
                <label for="label_data_agendamento">Data Vistoria:</label>
                <input type="date" class="form-control" id="data_vistoria" name="data_vistoria" value="<?php echo $date_format; ?>">
                <div class="form-inline" id="data_vistoria_error"></div>
            </div>
            <div class="form-group">
                <label for="label_data_agendamento">Área Total:</label>
                <input type="text" class="form-control" id="area_total" name="area_total" value="<?php echo $array['area_total']; ?>">
                <div class="form-inline" id="area_total_error"></div>
            </div>
            <div class="form-group">
                <label for="label_data_agendamento">Pé Direito:</label>
                <input type="text" class="form-control" id="pe_direito" name="pe_direito" value="<?php echo $array['pe_direito']; ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_paredes" name="id_paredes">
                    ...
                    foreach ($pdo->query($sql0) as $value) {
                        $option = $value['id'] == $array['id_paredes'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_piso" name="id_piso">
                    ...
                    foreach ($pdo->query($sql1) as $value) {
                        $option = $value['id'] == $array['id_piso'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_forro" name="id_forro">
                    ...
                    foreach ($pdo->query($sql2) as $value) {
                        $option = $value['id'] == $array['id_forro'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_iluminacao" name="id_iluminacao">
                    ...
                    foreach ($pdo->query($sql3) as $value) {
                        $option = $value['id'] == $array['id_iluminacao'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_lampadas" name="id_lampadas">
                    ...
                    foreach ($pdo->query($sql4) as $value) {
                        $option = $value['id'] == $array['id_lampadas'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_ventilacao" name="id_ventilacao">
                    ...
                    foreach ($pdo->query($sql5) as $value) {
                        $option = $value['id'] == $array['id_ventilacao'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_controle_limpeza_arcondicionado" name="id_tst_checklist_controle_limpeza_arcondicionado">
                    ...
                    foreach ($pdo->query($sql6) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_controle_limpeza_arcondicionado'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <?php
            $format_data1 = trim($array['agua_validade']);
            $date_format1 = date("Y-m-d", strtotime($format_data1));
            $format_data2 = trim($array['po_validade']);
            $date_format2 = date("Y-m-d", strtotime($format_data2));
            $format_data3 = trim($array['gas_validade']);
            $date_format3 = date("Y-m-d", strtotime($format_data3));
            ?>
            <div class="form-group">
                ...
                <table class="table table-noborder table-message">
                    <tr>
                        <td>Água</td>
                        <td><input type="text" class="form-control" id="agua_pc" name="agua_pc" value="<?php echo $array['agua_pc']; ?>"></td>
                        <td><input type="date" class="form-control" id="agua_validade" name="agua_validade" value="<?php echo $date_format1; ?>"></td>
                    </tr>
                    <tr>
                        <td>Pó Químico</td>
                        <td><input type="text" class="form-control" id="po_pc" name="po_pc" value="<?php echo $array['po_pc']; ?>"></td>
                        <td><input type="date" class="form-control" id="po_validade" name="po_validade" value="<?php echo $date_format2; ?>"></td>
                    </tr>
                    <tr>
                        <td>Gás Carbonico</td>
                        <td><input type="text" class="form-control" id="gas_pc" name="gas_pc" value="<?php echo $array['gas_pc']; ?>"></td>
                        <td><input type="date" class="form-control" id="gas_validade" name="gas_validade" value="<?php echo $date_format3; ?>"></td>
                    </tr>
                </table>                
            ...
            <div class="form-group">
                ...
                <table>
                    <tr>
                        <td>                                
                            <input type="checkbox" id="luz_emergencia_sim" name="luz_emergencia_sim" <?php echo $array['luz_emergencia_sim'] == 1 ? 'checked' : ''; ?>> Sim 
                        </td>
                        <td>                                
                            Quantas?<input type="text" id="luz_emergencia_quantas" name="luz_emergencia_quantas" value="<?php echo $array['luz_emergencia_quantas']; ?>">
                        </td>
                        <td>                                
                            <input type="checkbox" id="luz_emergencia_nao" name="luz_emergencia_nao" <?php echo $array['luz_emergencia_nao'] == 1 ? 'checked' : ''; ?>> Não 
                        </td>
                    </tr>
                </table>                
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_saida_de_emergencia" name="id_saida_de_emergencia">
                    ...
                    foreach ($pdo->query($sql7) as $value) {
                        $option = $value['id'] == $array['id_saida_de_emergencia'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_rota_saida_extintores" name="id_tst_checklist_rota_saida_extintores">
                    ...
                    foreach ($pdo->query($sql8) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_rota_saida_extintores'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <table>
                    <tr>
                        <td>                                
                            Quantidade?<input type="text" id="numero_funcionarios_quantos" name="numero_funcionarios_quantos" value="<?php echo $array['numero_funcionarios_quantos']; ?>">
                        </td>
                        <td>
                            <input type="checkbox" id="numero_funcionarios_no_possui_cipa" name="numero_funcionarios_no_possui_cipa" <?php echo $array['numero_funcionarios_no_possui_cipa'] == 1 ? 'checked' : ''; ?>> Não Possui CIPA
                        </td>
                        <td>                                
                            <input type="checkbox" id="numero_funcionarios_possui_cipa" name="numero_funcionarios_possui_cipa" <?php echo $array['numero_funcionarios_possui_cipa'] == 1 ? 'checked' : ''; ?>> Possui CIPA
                        </td>
                        <td>                                
                            <input type="checkbox" id="numero_funcionarios_colaborador_designado" name="numero_funcionarios_colaborador_designado"  <?php echo $array['numero_funcionarios_colaborador_designado'] == 1 ? 'checked' : ''; ?>> Colaborador Designado
                        </td>
                    </tr>
                </table>                
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_epi" name="id_tst_checklist_epi">
                    ...
                    foreach ($pdo->query($sql9) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_epi'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_trei_epi_epc" name="id_tst_checklist_trei_epi_epc">
                    ...
                    foreach ($pdo->query($sql10) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_trei_epi_epc'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_entrega_epi" name="id_tst_checklist_entrega_epi">
                    ...
                    foreach ($pdo->query($sql11) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_entrega_epi'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_insta_eletrica" name="id_tst_checklist_insta_eletrica">
                    ...
                    foreach ($pdo->query($sql12) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_insta_eletrica'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_atividades_ambiente" name="id_tst_checklist_atividades_ambiente">
                    ...
                    foreach ($pdo->query($sql13) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_atividades_ambiente'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_atividades_ambiente_interno" name="id_tst_checklist_atividades_ambiente_interno">
                    ...
                    foreach ($pdo->query($sql14) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_atividades_ambiente_interno'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_refeicoes" name="id_tst_checklist_refeicoes">
                    ...
                    foreach ($pdo->query($sql15) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_refeicoes'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_local_refeicoes" name="id_tst_checklist_local_refeicoes">
                    ...
                    foreach ($pdo->query($sql16) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_local_refeicoes'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_insta_sanitarias" name="id_tst_checklist_insta_sanitarias">
                    ...
                    foreach ($pdo->query($sql17) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_insta_sanitarias'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_pertence_funcionarios" name="id_tst_checklist_pertence_funcionarios">
                    ...
                    foreach ($pdo->query($sql18) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_pertence_funcionarios'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_avaliacao_ambiente_trab" name="id_tst_checklist_avaliacao_ambiente_trab">
                    ...
                    foreach ($pdo->query($sql19) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_avaliacao_ambiente_trab'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_seg_integracao" name="id_tst_checklist_seg_integracao">
                    ...
                    foreach ($pdo->query($sql20) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_seg_integracao'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_tst_checklist_trein_seg" name="id_tst_checklist_trein_seg">
                    ...
                    foreach ($pdo->query($sql21) as $value) {
                        $option = $value['id'] == $array['id_tst_checklist_trein_seg'] ? 'value="' . $value['id'] . '" selected' : 'value="' . $value['id'] . '"';
                        echo '<option ' . $option . '>' . utf8_encode($value['itens']) . '</option>';
                    }
                    ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select multiple class="form-control" id="id_tecnicos" name="id_tecnicos">
                    ...
                    <?php
                    $array_tecnicos = explode(',', $array['id_tecnicos']);
                ...
                <div class="form-inline" id="id_tecnicos_error"></div>
            </div>
            <div class="form-group">
                <label for="label_obs">Sugestão de Melhoria:</label>
                <textarea class="form-control" id="sugestao_melhoria" name="sugestao_melhoria" placeholder="Informe aqui, dados adicionais!!"><?php echo $array['sugestao_melhoria']; ?></textarea>
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-pinterest pull-right" id="envia" type="submit">Editar Checklist <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></button>
            </div>
