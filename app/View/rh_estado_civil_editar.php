...
$array_rh = $rh->Dados_RH_Estado_Civils($rh->get_id());
?>
...
<script>
    $(document).ready(function () {
        ...
        $("#fechar_modal").click(function () {
            $("#refresca_rh").load('rh_estado_civil_listar.php');
        });
        ...
        function envia_form() {
            ...
            $.ajax({
                type: "POST",
                dataType: "HTML",
                url: "../Controller/rh_estado_civil_editar.php",
...
<div class="modal-body">
    <form id="form" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nome" name="nome" placeholder="Informe..." value="<?php echo $array_rh['estado_civil']; ?>" autofocus>
