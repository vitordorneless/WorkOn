...
if ($gera === TRUE) {
    echo '<a class="btn btn-primary btn-facebook pull-right" href="../Controller/txt_2016_grafica_gerar_link.php?empresa=' . $empresa . '&estabelecimento=' . $estabelecimento . '&funcao=' . $funcao . '">Download do TXT</a>';
} else {
