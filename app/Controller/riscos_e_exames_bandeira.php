    ...
    $(document).ready(function () {
        ...
        function envia_form() {
            ...
            $.ajax({
                ...
                data: "bandeira=" + bandeira + "&cod_cargo=" + cod_cargo + "&agente_fisico=" + agente_fisico + "&agente_quimico=" + agente_quimico + "&agente_biologico=" + agente_biologico + "&agente_ergonomico=" + agente_ergonomico + "&ausencia_de_risco=" + ausencia_de_risco +
    ...
    <div class="panel-body">
        <form id="form" method="POST">
            <div class="form-group">
                <input type="hidden" class="form-control" id="bandeira" name="bandeira" value="<?php echo $bandeira; ?>">
                <input type="hidden" class="form-control" id="cod_cargo" name="cod_cargo" value="<?php echo $cargo; ?>">
                <input type="hidden" class="form-control" id="depto" name="depto" value="<?php echo $setor; ?>">
                <table>
                    <tr>
                        <td>
                            <div class="checkbox">
