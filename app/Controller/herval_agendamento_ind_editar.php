...
$herval->set_id_individual(filter_input(INPUT_POST, 'id_agendamento_individual', FILTER_SANITIZE_NUMBER_INT));
...
$confirm = $individual->edit_Herval_Agendamento_Individual($herval->get_id_individual(), $herval->get_id(), 
        $herval->get_id_convocacao(), $herval->get_id_unidade(), $herval->get_id_medico(), $herval->get_id_situacao(), $herval->get_data(), 
        $herval->get_horario(), 1);
