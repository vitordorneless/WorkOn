                    ...
                    <form class='form-horizontal' role='form'>
                        <table id="funcionarios" class="table table-responsive tab-boxed table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $sql = 'select id, matricula, prefixo_agencia, nome_ativo, data_nascimento, obs, id_cassi_situacao from cassi_ativos where nome_ativo like "%' . $search . '%" order by nome_ativo asc';
                                foreach ($pdo->query($sql) as $value) {
                                    ...
                                    echo '<td><a href="#" id="../Controller/cassi_exames_autonomo_incluir.php?id=' . $value['id'] . '" class="btn btn-default btn-danger">Incluir <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>';
                                    echo '</tr>';
                                }
                                Database::disconnect();
                                ?>
