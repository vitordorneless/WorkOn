...
$riscos->set_cod_cargo(filter_input(INPUT_POST, 'cargo', FILTER_SANITIZE_STRING));
$riscos->set_depto(filter_input(INPUT_POST, 'setor', FILTER_SANITIZE_STRING));
...
$riscos->set_anti_hbs(filter_input(INPUT_POST, 'anti_hbs', FILTER_SANITIZE_NUMBER_INT));
$riscos->set_hbs_ag(filter_input(INPUT_POST, 'hbs_ag', FILTER_SANITIZE_NUMBER_INT));
$riscos->set_anti_hbc(filter_input(INPUT_POST, 'anti_hbc', FILTER_SANITIZE_NUMBER_INT));
...
if (($riscos->get_agente_fisico() === '0') and ( $riscos->get_agente_biologico() === '0') and ( $riscos->get_agente_ergonomico() === '0')
    ...
    if (($riscos->get_exame_clinico() === '0') and ( $riscos->get_acido_metil_hipurico() === '0') and ( $riscos->get_hemograma() === '0')
        ...
        $cont_exames = 0;
        $cont_exames_fim = 0;
        $sql_geral = 'select id from wal_funcionarios where risco = 0 and id_wal_flags = ' . $riscos->get_bandeira() . ' and cod_depto = ' . $riscos->get_depto() . ' and cod_cargo in (' . $riscos->get_cod_cargo() . ')';
        $sql_geral_exames = 'select id from wal_funcionarios where exame = 0 and id_wal_flags = ' . $riscos->get_bandeira() . ' and cod_depto = ' . $riscos->get_depto() . ' and cod_cargo in (' . $riscos->get_cod_cargo() . ')';
        ...
        $quantos_ativos = $riscos->Quantos_Ativos_eu_peguei($riscos->get_bandeira(), $riscos->get_depto(), $riscos->get_cod_cargo());
