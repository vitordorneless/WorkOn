...
$kit->set_id(filter_input(INPUT_POST, 'id', FILTER_SANITIZE_NUMBER_INT));
...
$confirm = $kit->edit_Wal_Kit($kit->get_id(), $kit->get_id_convocacao(), $kit->get_rastreamento(), $kit->get_data_envio(), 1);
