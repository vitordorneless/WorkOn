...
if (($herval->get_agente_fisico() !== '1') and ($herval->get_agente_biologico() !== '1') and ($herval->get_agente_ergonomico() !== '1')
    ...
    $confirm = $herval->save_Herval_sint_body($herval->get_id(), $herval->get_id_herval_setor(),$herval->get_id_herval_funcao(),$herval->get_agente_fisico(), $herval->get_obs_agente_fisico(), 
