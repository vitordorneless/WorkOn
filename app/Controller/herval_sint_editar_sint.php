...
require '../Model/Herval_Sintese_Exames.php';
$herval = new Herval_Sintese_Exames();
$herval->set_id(filter_input(INPUT_POST, 'id_sinte_cab', FILTER_SANITIZE_NUMBER_INT));
$herval->set_id_unidade(filter_input(INPUT_POST, 'id', FILTER_SANITIZE_NUMBER_INT));
...
if (($herval->get_agente_fisico() !== '1') and ($herval->get_agente_biologico() !== '1') and ($herval->get_agente_ergonomico() !== '1')
    ...
    and ($herval->get_obs_7() !== '1')and ($herval->get_obs_8() !== '1')) {
    echo '<div class="alert alert-danger alert-dismissable">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            Preencha pelo Menos um...</div>';
} else {    
    $confirm = $herval->edit_Herval_sint_body($herval->get_id_unidade(),$herval->get_id(), $herval->get_agente_fisico(), $herval->get_obs_agente_fisico(), 
            $herval->get_agente_quimico(), $herval->get_obs_agente_quimico(), $herval->get_agente_biologico(), $herval->get_obs_agente_biologico(), 
            $herval->get_agente_ergonomico(), $herval->get_obs_agente_ergonomico(), $herval->get_ausencia_de_risco(), $herval->get_obs_ausencia_de_risco(), 
            $herval->get_exame_clinico(), $herval->get_acido_metil_hipurico(), $herval->get_hemograma(), $herval->get_acido_mandelico(), 
            $herval->get_vdrl(), $herval->get_reticulocitos(), $herval->get_parasitologico_fezes(), $herval->get_cultural_de_orofaringe(), 
            $herval->get_coprocultura(), $herval->get_micologico_de_unha(), $herval->get_audiometria(), $herval->get_ecg(), $herval->get_acuidade_visual(), 
            $herval->get_eeg(), $herval->get_plaquetas(), $herval->get_eritrograma(), $herval->get_acido_tt_muconico(), $herval->get_glicemia_em_jejum(), 
            $herval->get_avaliacao_psicossocial(), $herval->get_acido_hipurico(), $herval->get_obs_1(), $herval->get_obs_2(), $herval->get_obs_3(), 
            $herval->get_obs_4(), $herval->get_obs_5(), $herval->get_obs_6(), $herval->get_obs_7(), $herval->get_obs_8());
    echo $confirm == TRUE ? '<div class="alert alert-success" role="alert">Síntese Editada!</div>' : '<div class="alert alert-danger" role="alert">Errou!</div>';
}