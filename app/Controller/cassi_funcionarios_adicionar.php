...
$confirm = $cassi->save_Cassi_Ativos($cassi->get_matricula(), $cassi->get_prefixo(), $cassi->get_nome_ativo(), $cassi->get_id_sexo(), 
        0, $cassi->get_data_nascimento(), $cassi->get_data_posse(), '-');

if ($confirm === TRUE) {
    echo '<div class="alert alert-success alert-dismissable">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
Funcionário CASSI Gravado com Sucesso!!</div>';
} else {
