...
$confirm = $user->edit_User($user->get_id(), $user->get_nome(), $user->get_pass(), 
        $user->get_email(), $user->get_admin(), $user->get_nome_extenso(), $user->get_setor(), 
        $user->get_foto(), $user->get_status(), $user->get_crm(), $user->get_estado_crm());
if ($confirm === TRUE) {
