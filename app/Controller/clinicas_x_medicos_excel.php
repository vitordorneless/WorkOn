...
$sql = "select id, razao_social, if(CNES = 0,'N&atilde;o Informado',CNES) as CNES, data_cadastro from wal_prestadores where id not in (1,2) order by razao_social asc";
$html = '';
...
header("Content-Disposition: attachment; filename=clinicas_x_medicos.xls");
