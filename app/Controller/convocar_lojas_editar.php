...
$evento_convocacao->set_id(filter_input(INPUT_POST, 'id', FILTER_SANITIZE_NUMBER_INT));
...
$evento_convocacao->set_loja(filter_input(INPUT_POST, 'id_loja', FILTER_SANITIZE_NUMBER_INT));
...
$confirm = $evento_convocacao->edit_Evento_Convocacao($evento_convocacao->get_id(), $evento_convocacao->get_id_convocacao(), 0, $evento_convocacao->get_id_responsavel_walmart(), $evento_convocacao->get_turnos(), $evento_convocacao->get_empresa(), $evento_convocacao->get_loja(), $evento_convocacao->get_kit_entregue(), $evento_convocacao->get_observacao(), $evento_convocacao->get_vencimento_anterior(), $atendimentos, $email_walmart, $email_ama, 1);
if ($confirm === TRUE) {
